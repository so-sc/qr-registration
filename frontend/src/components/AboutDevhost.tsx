  ...
  return (
    <div className="flex justify-center pb-10 items-center w-full">
      <div className="max-w-6xl mb-20 w-full event_card md:mt-10 border-white/10 border rounded-xl pt-10 pb-10">
        <h1 className="select-none text-center text-2xl md:text-4xl font-semibold md:pb-0 pb-0">
          {devhostData.title}
        </h1>
          ...
          <div className="md:relative flex flex-col">
            <div className="event_card md:mt-10 border-none rounded-xl">
              <div className="ml-5 md:mt-5 md:ml-[6.5rem] my-5 md:mr-[6.5rem] mr-5">
                <h1 className="leading-6 mb-1 pt-2 font-semibold text-sm md:text-base text-primary tracking-wider">
                  {devhostData.caption}
                </h1>
                <p className="text-sm md:text-lg tracking-wider py-2">{devhostData.about}</p>
                <div className="flex flex-col md:flex-row md:items-center gap-4 mt-6">
                  <a href="/brochure/Event Rulebook - Devhost.pdf" download>
                    <HoverBorderGradient
                      containerClassName="rounded-full"
                      as="button"
                      className="bg-background w-full md:w-auto px-4 py-2 md:px-8 md:py-3 group flex items-center justify-center space-x-2"
                    >
